...
export default function Home() {
  return (
   ...
   <div className='grid grid-cols-12 gap-6 px-5 my-14 lx:px-48 sm:px-20 md:px-32 lg:px-36 lg:mb-0 md:mb-16 bg-gradient-to-r from-green to-blue-400 dark:from-dark-700 dark:to-dark-700'>
